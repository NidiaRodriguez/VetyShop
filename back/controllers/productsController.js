...
exports.deleteProduct = catchAsyncErrors(async (req, res, next) => {
    ...
    if (!product) { //Verifico que el objeto no existe para finalizar el proceso 
        return next(new ErrorHandler("Producto no encontrado", 404))  //Si el objeto no existe, return termina el metodo
    }
...
//verProductoPorID('634746fa66574dfa846672b8'); //Probamos el metodo con un id