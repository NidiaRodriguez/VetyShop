   ...
   {loading ? <i class="fa fa-refresh fa-spin fa-3x fa-fw"></i> :(
     ...
     <div className='row d-flex justify-content-around'>
         ...
         <div className='col-12 col-lg-5 mt-5'>
             ...
             <p id="Product_id">ID del producto {product.id}</p>
             <hr />
             ...
             <button id="btn_reviews" type="button" className="btn btn_primary mt-4" 
             ...
             {/*Mensaje emergente para dejar opinion y calificaion*/}
